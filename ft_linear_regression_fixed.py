...
theta0 = 0
theta1 = 0
learning_rate = 0.1  # Learning rate plus adapté pour des données normalisées
...
# Conversion vers l'espace original
...
# Test de prédiction
test_km = 100000
predicted_price = theta0_original + theta1_original * test_km
print(f"\nTest de prédiction : Pour {test_km} km, le prix estimé est {predicted_price:.2f} €")